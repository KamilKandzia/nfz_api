yearlyProvision <- function(id, label = "yearlyProvision1") {
  ...
  bs4TabItem(
    ...
    fluidRow(
      dropdown(
        ...
        pickerInput(inputId = ns("legends_year"),
                    label = "Show legend",
                    choices = c(TRUE, FALSE),
                    selected =TRUE,
                    options = list(`style` = "btn-info")),
        
        pickerInput(inputId = ns("labels_year"),
                    label = "Show labels",
                    choices = c(TRUE, FALSE),
                    selected = TRUE,
                    options = list(`style` = "btn-info")),
      ...
      actionBttn(
        inputId = ns("analyseYearly"),
        label = "Analyse yearly provision", 
        style = "bordered",
        color = "primary",
        icon = icon("chart-pie")
      )
    ...
    fluidRow(
      bs4Card(width = 12,
              ...
              bs4Dash::column(
                width = 12,
                align = "center",
                DTOutput(ns("tbl_yearly"))),status = "navy")),
    ...
    fluidRow(
      ...
      bs4Card(width = 12, maximizable = TRUE,
              ...
              bs4Dash::column(
                width = 12,
                align = "center",
                tags$div(id="test1_yearly", style="width:90%;height:400px;"),
                deliverChart(div_id = ns("test1_yearly"))),status = "navy")),
    
    
    fluidRow(
      loadEChartsLibrary(),
      bs4Card(width = 12, maximizable = TRUE,
              title = "Refund per year",
              bs4Dash::column(
                width = 12,
                align = "center",
                tags$div(id="test_yearly", style="width:90%;height:400px;"),
                deliverChart(div_id = ns("test_yearly"))),status = "navy")),
    ...
    fluidRow(
      bs4Card(width = 12, maximizable = TRUE,
              ...
              bs4Dash::column(
                width = 12,
                align = "center",
                plotOutput(ns("plt_yearly2017"))),status = "navy")),
    ...
    fluidRow(
      bs4Card(width = 12, maximizable = TRUE,
              ...
              bs4Dash::column(
                width = 12,
                align = "center",
                plotOutput(ns("plt_yearly2018"))),status = "navy")),
    ...
    fluidRow(
      bs4Card(width = 12,
              ...
              bs4Dash::column(
                width = 12,
                align = "center",
                DTOutput(ns("tbl_yearly_values"))),status = "navy")),
    
    fluidRow(
      bs4ValueBoxOutput(ns("vbox_year")))
